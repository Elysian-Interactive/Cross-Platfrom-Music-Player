...
# Test 4 : This test will go through a couple of scenarios to extend the functionality of the music player
#       -> How to handle the pause/play functionality when the song is loaded for the first time (maybe this could be handled in the GUI)
#       -> How to handle the event when the song has stopped but the repeat option is switched off and now when I click the prev button it takes me
#          to the previous song instead of rewinding the song (check for other players and how they handle it)
# Another test case is to check for the length of the list
